...
public class WeekWindow extends ListWindow {
	...
	protected void onCreate(Bundle bundle) {
		...
		Log.v("eldar", "WeekWindow: onCreate");
		...
		Log.v("eldar", "WeekWindow: created");
	}
	...
	protected void onDestroy() {
		Log.v("eldar", "WeekWindow: onDestroy");
		super.onDestroy();
		Log.v("eldar", "WeekWindow: destroyed");
	}
	...
	private void performClearAllDialogOkPressed() {
		Log.v("eldar", "WeekWindow: performClearAllDialogOkPressed");
		clearAllItems();
		refreshListActivity();
	}
